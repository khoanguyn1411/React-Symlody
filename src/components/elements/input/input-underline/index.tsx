      ...
      <label className="flex items-center">
        ...
        <div className="relative w-full ml-2 min-w-[200px]">
          <input
            ...
            disabled={disable}
            className="w-full h-full font-sans text-base font-normal text-gray-font bg-transparent border-b border-gray-300 peer outline-0 focus:outlined-0  disabled:text-gray-400 transition-all placeholder-shown:border-gray-300 focus:border-primary-800"
          />
