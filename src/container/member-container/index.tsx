        ...
        <div className="mt-3 bg-white border border-gray-200 rounded-lg">
          <table className="w-full">
            ...
            <tr className="text-left border-t border-gray-200">
              <th className="w-2/5 py-2 font-normal px-default">
                <div className="flex items-center">
              ...
              <th className="w-1/5 py-2 font-normal">Sự kiện</th>
              <th className="w-1/5 py-2 font-normal">11/01/1999</th>
              <th className="w-1/5 py-2 font-normal">Leader</th>
            </tr>
